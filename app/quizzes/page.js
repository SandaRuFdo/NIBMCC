...
const quizList = [
  { key: 'module-1', title: 'Module 1 Quiz', subtitle: 'Security Principles', domain: 1, questions: 55, weight: '26%' },
  { key: 'module-2', title: 'Module 2 Quiz', subtitle: 'BC / DR / IR', domain: 2, questions: 30, weight: '10%' },
  { key: 'module-3', title: 'Module 3 Quiz', subtitle: 'Access Controls', domain: 3, questions: 40, weight: '22%' },
  { key: 'module-4', title: 'Module 4 Quiz', subtitle: 'Network Security', domain: 4, questions: 40, weight: '24%' },
  { key: 'module-5', title: 'Module 5 Quiz', subtitle: 'Security Operations', domain: 5, questions: 35, weight: '18%' },
  { key: 'practice-exam', title: 'Full Practice Exam', subtitle: 'All 5 Domains', domain: 0, questions: 100, weight: '100%' },
];
